  ...
  <body>
    <div class="bgimg w3-display-container w3-animate-opacity w3-text-white">
      ...
      <div class="w3-display-topright" style="text-align:center;background-color:trasparent;margin-right:5% ;">
        ...
        USERNAME<br><input type="text" size="20" name="userid"style="background-color:#ffffff;opacity: .4;"><br>
        PASSWORD<br><input type="password" size="20" name="userpass" style="background-color:#ffffff;opacity: .4;"><br>
